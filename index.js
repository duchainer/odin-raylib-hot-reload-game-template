...
// include: /tmp/tmpla3r9ws_.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'game_web/index.data';
...
Module['FS_createPath']("/", "assets", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_game_web/index.data');

      };
      Module['addRunDependency']('datafile_game_web/index.data');
...
// end include: /tmp/tmpla3r9ws_.js
// include: /tmp/tmp4is2229x.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp4is2229x.js
// include: /tmp/tmpovxcejga.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpovxcejga.js
...
var ASM_CONSTS = {
  125592: () => { if (document.fullscreenElement) return 1; },  
 125638: () => { return document.getElementById('canvas').width; },  
 125690: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125758: () => { document.exitFullscreen(); },  
 125785: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 125858: () => { if (document.fullscreenElement) return 1; },  
 125904: () => { return document.getElementById('canvas').width; },  
 125956: () => { return screen.width; },  
 125981: () => { document.exitFullscreen(); },  
 126008: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 126141: () => { return window.innerWidth; },  
 126167: () => { return window.innerHeight; },  
 126194: () => { if (document.fullscreenElement) return 1; },  
 126240: () => { return document.getElementById('canvas').width; },  
 126292: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126360: () => { if (document.fullscreenElement) return 1; },  
 126406: () => { return document.getElementById('canvas').width; },  
 126458: () => { return screen.width; },  
 126483: () => { return window.innerWidth; },  
 126509: () => { return window.innerHeight; },  
 126536: () => { if (document.fullscreenElement) return 1; },  
 126582: () => { return document.getElementById('canvas').width; },  
 126634: () => { return screen.width; },  
 126659: () => { document.exitFullscreen(); },  
 126686: () => { if (document.fullscreenElement) return 1; },  
 126732: () => { return document.getElementById('canvas').width; },  
 126784: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126852: () => { document.exitFullscreen(); },  
 126879: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 126937: () => { return screen.width; },  
 126962: () => { return screen.height; },  
 126988: () => { return window.screenX; },  
 127015: () => { return window.screenY; },  
 127042: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 127095: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 127166: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 127223: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 127479: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 127550: () => { if (document.fullscreenElement) return 1; },  
 127596: () => { return window.innerWidth; },  
 127622: () => { return window.innerHeight; },  
 127649: () => { if (document.pointerLockElement) return 1; }
};
var wasmImports = {
  /** @export */
