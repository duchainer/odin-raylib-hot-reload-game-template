...
*/
sqlite3_callback :: proc "c" (rawptr
	, i32
	, ^cstring
	, ^cstring) -> i32
...
foreign lib {
	...
	** </ul>
	*/
	sqlite3_exec :: proc(_: ^sqlite3       /* An open database */
	, sql: cstring /* SQL to be evaluated */
	, callback: proc "c" (rawptr
	, i32
	, ^cstring
	, ^cstring /* Callback function */) -> i32
	, _: rawptr       /* 1st argument to callback */
	, errmsg: ^cstring /* Error msg written here */) -> i32 --- /* An open database */
}
...
sqlite3_io_methods :: struct {
	...
	xRead: proc "c" (_: ^sqlite3_file
	, _: rawptr
	, iAmt: i32
	, iOfst: sqlite3_int64) -> i32,

	xWrite: proc "c" (_: ^sqlite3_file
	, _: rawptr
	, iAmt: i32
	, iOfst: sqlite3_int64) -> i32,

	xTruncate: proc "c" (_: ^sqlite3_file
	, size: sqlite3_int64) -> i32,

	xSync: proc "c" (_: ^sqlite3_file
	, flags: i32) -> i32,

	xFileSize: proc "c" (_: ^sqlite3_file
	, pSize: ^sqlite3_int64) -> i32,

	xLock: proc "c" (^sqlite3_file
	, i32) -> i32,

	xUnlock: proc "c" (^sqlite3_file
	, i32) -> i32,

	xCheckReservedLock: proc "c" (_: ^sqlite3_file
	, pResOut: ^i32) -> i32,

	xFileControl: proc "c" (_: ^sqlite3_file
	, op: i32
	, pArg: rawptr) -> i32,
	...
	xShmMap: proc "c" (_: ^sqlite3_file
	, iPg: i32
	, pgsz: i32
	, _: i32
	, _: ^rawptr) -> i32,

	xShmLock: proc "c" (_: ^sqlite3_file
	, offset: i32
	, n: i32
	, flags: i32) -> i32,
	...
	xShmUnmap: proc "c" (_: ^sqlite3_file
	, deleteFlag: i32) -> i32,

	/* Methods above are valid for version 2 */
	xFetch: proc "c" (_: ^sqlite3_file
	, iOfst: sqlite3_int64
	, iAmt: i32
	, pp: ^rawptr) -> i32,

	xUnfetch: proc "c" (_: ^sqlite3_file
	, iOfst: sqlite3_int64
	, p: rawptr) -> i32,
}
...
sqlite3_vfs :: struct {
	...
	xOpen: proc "c" (_: ^sqlite3_vfs
	, zName: sqlite3_filename
	, _: ^sqlite3_file
	, flags: i32
	, pOutFlags: ^i32) -> i32,

	xDelete: proc "c" (_: ^sqlite3_vfs
	, zName: cstring
	, syncDir: i32) -> i32,

	xAccess: proc "c" (_: ^sqlite3_vfs
	, zName: cstring
	, flags: i32
	, pResOut: ^i32) -> i32,

	xFullPathname: proc "c" (_: ^sqlite3_vfs
	, zName: cstring
	, nOut: i32
	, zOut: cstring) -> i32,

	xDlOpen: proc "c" (_: ^sqlite3_vfs
	, zFilename: cstring) -> rawptr,

	xDlError: proc "c" (_: ^sqlite3_vfs
	, nByte: i32
	, zErrMsg: cstring),

	xDlSym: proc "c" (_: ^sqlite3_vfs
	, _: rawptr
	, zSymbol: cstring) -> proc "c" (),

	xDlClose: proc "c" (^sqlite3_vfs
	, rawptr),

	xRandomness: proc "c" (_: ^sqlite3_vfs
	, nByte: i32
	, zOut: cstring) -> i32,

	xSleep: proc "c" (_: ^sqlite3_vfs
	, microseconds: i32) -> i32,

	xCurrentTime: proc "c" (^sqlite3_vfs
	, ^f64) -> i32,

	xGetLastError: proc "c" (^sqlite3_vfs
	, i32
	, cstring) -> i32,
	...
	*/
	xCurrentTimeInt64: proc "c" (^sqlite3_vfs
	, ^sqlite3_int64) -> i32,
	...
	*/
	xSetSystemCall: proc "c" (_: ^sqlite3_vfs
	, zName: cstring
	, _: sqlite3_syscall_ptr) -> i32,

	xGetSystemCall: proc "c" (_: ^sqlite3_vfs
	, zName: cstring) -> sqlite3_syscall_ptr,

	xNextSystemCall: proc "c" (_: ^sqlite3_vfs
...
foreign lib {
	...
	*/
	sqlite3_db_config :: proc(_: ^sqlite3
	, op: i32, #c_vararg _: ..any) -> i32 ---
}

sqlite3_mem_methods :: struct {
	xMalloc: proc "c" (i32          /* Memory allocation function */) -> rawptr, /* Memory allocation function */
	xFree:   proc "c" (rawptr          /* Free a prior allocation */),           /* Free a prior allocation */

	xRealloc: proc "c" (rawptr /* Resize an allocation */
	, i32 /* Resize an allocation */) -> rawptr, /* Resize an allocation */

	xSize:     proc "c" (rawptr           /* Return the size of an allocation */) -> i32,      /* Return the size of an allocation */
	xRoundup:  proc "c" (i32           /* Round up request size to allocation size */) -> i32, /* Round up request size to allocation size */
	xInit:     proc "c" (rawptr           /* Initialize the memory allocator */) -> i32,       /* Initialize the memory allocator */
	xShutdown: proc "c" (rawptr      /* Deinitialize the memory allocator */),                 /* Deinitialize the memory allocator */
...
foreign lib {
	...
	*/
	sqlite3_extended_result_codes :: proc(_: ^sqlite3
	, onoff: i32) -> i32 ---
}
	...
	*/
	sqlite3_set_last_insert_rowid :: proc(^sqlite3
	, sqlite3_int64) ---
}
	...
	*/
	sqlite3_busy_handler :: proc(^sqlite3
	, proc "c" (rawptr
	, i32) -> i32
	, rawptr) -> i32 ---
}
	...
	*/
	sqlite3_busy_timeout :: proc(_: ^sqlite3
	, ms: i32) -> i32 ---
}
	...
	** has been released.
	*/
	sqlite3_setlk_timeout :: proc(_: ^sqlite3
	, ms: i32
	, flags: i32) -> i32 ---
}
...
foreign lib {
	...
	** [sqlite3_errmsg()].
	*/
	sqlite3_get_table :: proc(db: ^sqlite3       /* An open database */
	, zSql: cstring  /* SQL to be evaluated */
	, pazResult: ^^cstring /* Results of the query */
	, pnRow: ^i32        /* Number of result rows written here */
	, pnColumn: ^i32     /* Number of result columns written here */
	, pzErrmsg: ^cstring    /* Error msg written here */) -> i32 ---
}
...
foreign lib {
	...
	*/
	...
	sqlite3_vmprintf :: proc(cstring
	, c.va_list) -> cstring ---
}

	sqlite3_snprintf :: proc(i32
	, cstring
	, cstring, #c_vararg ..any) -> cstring ---
}

	sqlite3_vsnprintf :: proc(i32
	, cstring
	, cstring
	, c.va_list) -> cstring ---
}
	...
	*/
	...
	sqlite3_realloc :: proc(rawptr
	, i32) -> rawptr ---
}

	sqlite3_realloc64 :: proc(rawptr
	, sqlite3_uint64) -> rawptr ---
}
...
foreign lib {
	...
	** profile callback.
	*/
	sqlite3_trace :: proc(_: ^sqlite3
	, xTrace: proc "c" (rawptr
	, cstring)
	, _: rawptr) -> rawptr ---
}

	sqlite3_profile :: proc(_: ^sqlite3
	, xProfile: proc "c" (rawptr
	, cstring
	, sqlite3_uint64)
	, _: rawptr) -> rawptr ---
}
...
foreign lib {
	...
	** are deprecated.
	*/
	sqlite3_trace_v2 :: proc(_: ^sqlite3
	, uMask: u32
	, xCallback: proc "c" (u32
	, rawptr
	, rawptr
	, rawptr) -> i32
	, pCtx: rawptr) -> i32 ---
	...
	*/
	sqlite3_progress_handler :: proc(^sqlite3
	, i32
	, proc "c" (rawptr) -> i32
	, rawptr) ---
}
	...
	*/
	sqlite3_open :: proc(filename: cstring /* Database filename (UTF-8) */
	, ppDb: ^^sqlite3        /* OUT: SQLite db handle */) -> i32 ---
}

	sqlite3_open16 :: proc(filename: rawptr /* Database filename (UTF-16) */
	, ppDb: ^^sqlite3        /* OUT: SQLite db handle */) -> i32 ---
}

	sqlite3_open_v2 :: proc(filename: cstring /* Database filename (UTF-8) */
	, ppDb: ^^sqlite3       /* OUT: SQLite db handle */
	, flags: i32            /* Flags */
	, zVfs: cstring      /* Name of VFS module to use */) -> i32 ---
}
	...
	*/
	sqlite3_uri_parameter :: proc(z: sqlite3_filename
	, zParam: cstring) -> cstring ---
}

	sqlite3_uri_boolean :: proc(z: sqlite3_filename
	, zParam: cstring
	, bDefault: i32) -> i32 ---
}

	sqlite3_uri_int64 :: proc(sqlite3_filename
	, cstring
	, sqlite3_int64) -> sqlite3_int64 ---
}

	sqlite3_uri_key :: proc(z: sqlite3_filename
	, N: i32) -> cstring ---
}
	...
	*/
	sqlite3_create_filename :: proc(zDatabase: cstring
	, zJournal: cstring
	, zWal: cstring
	, nParam: i32
	, azParam: ^cstring) -> sqlite3_filename ---
}
	...
	*/
	sqlite3_set_errmsg :: proc(db: ^sqlite3
	, errcode: i32
	, zErrMsg: cstring) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_prepare :: proc(db: ^sqlite3           /* Database handle */
	...
	sqlite3_prepare_v3 :: proc(db: ^sqlite3            /* Database handle */
	, zSql: cstring       /* SQL statement, UTF-8 encoded */
	, nByte: i32              /* Maximum length of zSql in bytes. */
	, prepFlags: u32 /* Zero or more SQLITE_PREPARE_ flags */
	, ppStmt: ^^sqlite3_stmt  /* OUT: Statement handle */
	, pzTail: ^cstring     /* OUT: Pointer to unused portion of zSql */) -> i32 ---
}

	sqlite3_prepare16 :: proc(db: ^sqlite3           /* Database handle */
	, zSql: rawptr      /* SQL statement, UTF-16 encoded */
	, nByte: i32             /* Maximum length of zSql in bytes. */
	, ppStmt: ^^sqlite3_stmt /* OUT: Statement handle */
	, pzTail: ^rawptr    /* OUT: Pointer to unused portion of zSql */) -> i32 ---
}

	sqlite3_prepare16_v2 :: proc(db: ^sqlite3           /* Database handle */
	, zSql: rawptr      /* SQL statement, UTF-16 encoded */
	, nByte: i32             /* Maximum length of zSql in bytes. */
	, ppStmt: ^^sqlite3_stmt /* OUT: Statement handle */
	, pzTail: ^rawptr    /* OUT: Pointer to unused portion of zSql */) -> i32 ---
	...
	sqlite3_prepare16_v3 :: proc(db: ^sqlite3            /* Database handle */
	, zSql: rawptr       /* SQL statement, UTF-16 encoded */
	, nByte: i32              /* Maximum length of zSql in bytes. */
	, prepFlags: u32 /* Zero or more SQLITE_PREPARE_ flags */
	, ppStmt: ^^sqlite3_stmt  /* OUT: Statement handle */
	...
	*/
	sqlite3_stmt_explain :: proc(pStmt: ^sqlite3_stmt
	, eMode: i32) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_bind_blob :: proc(_: ^sqlite3_stmt
	, _: i32
	, _: rawptr
	, n: i32
	, _: proc "c" (rawptr)) -> i32 ---
	...
	sqlite3_bind_blob64 :: proc(^sqlite3_stmt
	, i32
	, rawptr
	, sqlite3_uint64
	, proc "c" (rawptr)) -> i32 ---
	...
	sqlite3_bind_double :: proc(^sqlite3_stmt
	, i32
	, f64) -> i32 ---
}

	sqlite3_bind_int :: proc(^sqlite3_stmt
	, i32
	, i32) -> i32 ---
}

	sqlite3_bind_int64 :: proc(^sqlite3_stmt
	, i32
	, sqlite3_int64) -> i32 ---
}

	sqlite3_bind_null :: proc(^sqlite3_stmt
	, i32) -> i32 ---
}

	sqlite3_bind_text :: proc(^sqlite3_stmt
	, i32
	, cstring
	, i32
	, proc "c" (rawptr)) -> i32 ---
	...
	sqlite3_bind_text16 :: proc(^sqlite3_stmt
	, i32
	, rawptr
	, i32
	, proc "c" (rawptr)) -> i32 ---
	...
	sqlite3_bind_text64 :: proc(_: ^sqlite3_stmt
	, _: i32
	, _: cstring
	, _: sqlite3_uint64
	, _: proc "c" (rawptr)
	...
	sqlite3_bind_value :: proc(^sqlite3_stmt
	, i32
	, ^sqlite3_value) -> i32 ---
}

	sqlite3_bind_pointer :: proc(^sqlite3_stmt
	, i32
	, rawptr
	, cstring
	, proc "c" (rawptr)) -> i32 ---
	...
	sqlite3_bind_zeroblob :: proc(_: ^sqlite3_stmt
	, _: i32
	, n: i32) -> i32 ---
}

	sqlite3_bind_zeroblob64 :: proc(^sqlite3_stmt
	, i32
	, sqlite3_uint64) -> i32 ---
}
	...
	** [sqlite3_bind_parameter_index()].
	*/
	sqlite3_bind_parameter_name :: proc(^sqlite3_stmt
	, i32) -> cstring ---
}
	...
	*/
	sqlite3_bind_parameter_index :: proc(_: ^sqlite3_stmt
	, zName: cstring) -> i32 ---
}
	...
	*/
	sqlite3_column_name :: proc(_: ^sqlite3_stmt
	, N: i32) -> cstring ---
}

	sqlite3_column_name16 :: proc(_: ^sqlite3_stmt
	, N: i32) -> rawptr ---
}
	...
	*/
	sqlite3_column_database_name :: proc(^sqlite3_stmt
	, i32) -> cstring ---
}

	sqlite3_column_database_name16 :: proc(^sqlite3_stmt
	, i32) -> rawptr ---
}

	sqlite3_column_table_name :: proc(^sqlite3_stmt
	, i32) -> cstring ---
}

	sqlite3_column_table_name16 :: proc(^sqlite3_stmt
	, i32) -> rawptr ---
}

	sqlite3_column_origin_name :: proc(^sqlite3_stmt
	, i32) -> cstring ---
}

	sqlite3_column_origin_name16 :: proc(^sqlite3_stmt
	, i32) -> rawptr ---
}
	...
	*/
	sqlite3_column_decltype :: proc(^sqlite3_stmt
	, i32) -> cstring ---
}

	sqlite3_column_decltype16 :: proc(^sqlite3_stmt
	, i32) -> rawptr ---
}
...
foreign lib {
	...
	*/
	sqlite3_column_blob :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> rawptr ---
}

	sqlite3_column_double :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> f64 ---
}

	sqlite3_column_int :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> i32 ---
}

	sqlite3_column_int64 :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> sqlite3_int64 ---
}

	sqlite3_column_text :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> ^u8 ---
}

	sqlite3_column_text16 :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> rawptr ---
}

	sqlite3_column_value :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> ^sqlite3_value ---
}

	sqlite3_column_bytes :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> i32 ---
}

	sqlite3_column_bytes16 :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> i32 ---
}

	sqlite3_column_type :: proc(_: ^sqlite3_stmt
	, iCol: i32) -> i32 ---
}
	...
	*/
	sqlite3_create_function :: proc(db: ^sqlite3
	, zFunctionName: cstring
	, nArg: i32
	, eTextRep: i32
	, pApp: rawptr
	, xFunc: proc "c" (^sqlite3_context
	, i32
	, ^^sqlite3_value)
	, xStep: proc "c" (^sqlite3_context
	, i32
	, ^^sqlite3_value)
	, xFinal: proc "c" (^sqlite3_context)) -> i32 ---
}

	sqlite3_create_function16 :: proc(db: ^sqlite3
	, zFunctionName: rawptr
	, nArg: i32
	, eTextRep: i32
	, pApp: rawptr
	, xFunc: proc "c" (^sqlite3_context
	...
	sqlite3_create_function_v2 :: proc(db: ^sqlite3
	, zFunctionName: cstring
	, nArg: i32
	, eTextRep: i32
	, pApp: rawptr
	...
	, xDestroy: proc "c" (rawptr)) -> i32 ---
}

	sqlite3_create_window_function :: proc(db: ^sqlite3
	, zFunctionName: cstring
	, nArg: i32
	, eTextRep: i32
	, pApp: rawptr
	...
	, xInverse: proc "c" (^sqlite3_context
	, i32
	, ^^sqlite3_value)
	, xDestroy: proc "c" (rawptr)) -> i32 ---
}
...
foreign lib {
	...
	sqlite3_transfer_bindings :: proc(^sqlite3_stmt
	, ^sqlite3_stmt) -> i32 ---
}
	...
	sqlite3_memory_alarm :: proc(proc "c" (rawptr
	, sqlite3_int64
	, i32)
	, rawptr
	, sqlite3_int64) -> i32 ---
	...
	*/
	...
	sqlite3_value_pointer :: proc(^sqlite3_value
	, cstring) -> rawptr ---
}
	...
	*/
	sqlite3_aggregate_context :: proc(_: ^sqlite3_context
	, nBytes: i32) -> rawptr ---
}
	...
	*/
	sqlite3_get_auxdata :: proc(_: ^sqlite3_context
	, N: i32) -> rawptr ---
}

	sqlite3_set_auxdata :: proc(_: ^sqlite3_context
	, N: i32
	, _: rawptr
	, _: proc "c" (rawptr)) ---
}
	...
	*/
	sqlite3_get_clientdata :: proc(^sqlite3
	, cstring) -> rawptr ---
}

	sqlite3_set_clientdata :: proc(^sqlite3
	, cstring
	, rawptr
	, proc "c" (rawptr)) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_result_blob :: proc(^sqlite3_context
	, rawptr
	, i32
	, proc "c" (rawptr)) ---
}

	sqlite3_result_blob64 :: proc(^sqlite3_context
	, rawptr
	, sqlite3_uint64
	, proc "c" (rawptr)) ---
}

	sqlite3_result_double :: proc(^sqlite3_context
	, f64) ---
}

	sqlite3_result_error :: proc(^sqlite3_context
	, cstring
	, i32) ---
}

	sqlite3_result_error16 :: proc(^sqlite3_context
	, rawptr
	, i32) ---
}
	...
	sqlite3_result_error_code :: proc(^sqlite3_context
	, i32) ---
}

	sqlite3_result_int :: proc(^sqlite3_context
	, i32) ---
}

	sqlite3_result_int64 :: proc(^sqlite3_context
	, sqlite3_int64) ---
}

	sqlite3_result_null :: proc(^sqlite3_context) ---

	sqlite3_result_text :: proc(^sqlite3_context
	, cstring
	, i32
	, proc "c" (rawptr)) ---
}

	sqlite3_result_text64 :: proc(_: ^sqlite3_context
	, _: cstring
	, _: sqlite3_uint64
	, _: proc "c" (rawptr)
	, encoding: u8) ---
	...
	sqlite3_result_text16 :: proc(^sqlite3_context
	, rawptr
	, i32
	, proc "c" (rawptr)) ---
}

	sqlite3_result_text16le :: proc(^sqlite3_context
	, rawptr
	, i32
	, proc "c" (rawptr)) ---
}

	sqlite3_result_text16be :: proc(^sqlite3_context
	, rawptr
	, i32
	, proc "c" (rawptr)) ---
}

	sqlite3_result_value :: proc(^sqlite3_context
	, ^sqlite3_value) ---
}

	sqlite3_result_pointer :: proc(^sqlite3_context
	, rawptr
	, cstring
	, proc "c" (rawptr)) ---
}

	sqlite3_result_zeroblob :: proc(_: ^sqlite3_context
	, n: i32) ---
}

	sqlite3_result_zeroblob64 :: proc(_: ^sqlite3_context
	, n: sqlite3_uint64) -> i32 ---
}
	...
	** by default.
	*/
	sqlite3_result_subtype :: proc(^sqlite3_context
	, u32) ---
}
	...
	*/
	sqlite3_create_collation :: proc(_: ^sqlite3
	, zName: cstring
	, eTextRep: i32
	, pArg: rawptr
	, xCompare: proc "c" (rawptr
	, i32
	, rawptr
	, i32
	, rawptr) -> i32) -> i32 ---
	...
	sqlite3_create_collation_v2 :: proc(_: ^sqlite3
	, zName: cstring
	, eTextRep: i32
	, pArg: rawptr
	, xCompare: proc "c" (rawptr
	...
	sqlite3_create_collation16 :: proc(_: ^sqlite3
	, zName: rawptr
	, eTextRep: i32
	, pArg: rawptr
	, xCompare: proc "c" (rawptr
	...
	*/
	sqlite3_collation_needed :: proc(^sqlite3
	, rawptr
	, proc "c" (_: rawptr
	, _: ^sqlite3
	, eTextRep: i32
	...
	sqlite3_collation_needed16 :: proc(^sqlite3
	, rawptr
	, proc "c" (_: rawptr
	, _: ^sqlite3
	, eTextRep: i32
	...
	*/
	sqlite3_win32_set_directory :: proc(type: c.ulong /* Identifier for directory being set or reset */
	, zValue: rawptr        /* New value for directory being set or reset */) -> i32 ---
}

	sqlite3_win32_set_directory8 :: proc(type: c.ulong
	, zValue: cstring) -> i32 ---
}

	sqlite3_win32_set_directory16 :: proc(type: c.ulong
	, zValue: rawptr) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_db_name :: proc(db: ^sqlite3
	, N: i32) -> cstring ---
}
	...
	** </ul>
	*/
	sqlite3_db_filename :: proc(db: ^sqlite3
	, zDbName: cstring) -> sqlite3_filename ---
}
	...
	*/
	sqlite3_db_readonly :: proc(db: ^sqlite3
	, zDbName: cstring) -> i32 ---
}
	...
	*/
	sqlite3_txn_state :: proc(_: ^sqlite3
	, zSchema: cstring) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_next_stmt :: proc(pDb: ^sqlite3
	, pStmt: ^sqlite3_stmt) -> ^sqlite3_stmt ---
}
	...
	*/
	sqlite3_commit_hook :: proc(^sqlite3
	, proc "c" (rawptr) -> i32
	, rawptr) -> rawptr ---
}

	sqlite3_rollback_hook :: proc(^sqlite3
	, proc "c" (rawptr)
	, rawptr) -> rawptr ---
}
	...
	** </pre></blockquote>
	*/
	sqlite3_autovacuum_pages :: proc(db: ^sqlite3
	, _: proc "c" (rawptr
	, cstring
	, u32
	, u32
	...
	*/
	sqlite3_update_hook :: proc(^sqlite3
	, proc "c" (rawptr
	, i32
	, cstring
	, cstring
	...
	*/
	sqlite3_table_column_metadata :: proc(db: ^sqlite3             /* Connection handle */
	...
	, pNotNull: ^i32           /* OUTPUT: True if NOT NULL constraint exists */
	, pPrimaryKey: ^i32        /* OUTPUT: True if column part of PK */
	, pAutoinc: ^i32            /* OUTPUT: True if column is auto-increment */) -> i32 ---
}
	...
	*/
	sqlite3_load_extension :: proc(db: ^sqlite3       /* Load the extension into this database connection */
	, zFile: cstring /* Name of the shared library containing extension */
	, zProc: cstring /* Entry point.  Derived from zFile if 0 */
	, pzErrMsg: ^cstring    /* Put error message here if not 0 */) -> i32 ---
}
	...
	** access to extension loading capabilities.
	*/
	sqlite3_enable_load_extension :: proc(db: ^sqlite3
	, onoff: i32) -> i32 ---
}
...
sqlite3_module :: struct {
	...
	xBestIndex: proc "c" (pVTab: ^sqlite3_vtab
	, _: ^sqlite3_index_info) -> i32,

	xDisconnect: proc "c" (pVTab: ^sqlite3_vtab) -> i32,
	xDestroy:    proc "c" (pVTab: ^sqlite3_vtab) -> i32,

	xOpen: proc "c" (pVTab: ^sqlite3_vtab
	, ppCursor: ^^sqlite3_vtab_cursor) -> i32,

	xClose: proc "c" (^sqlite3_vtab_cursor) -> i32,

	xFilter: proc "c" (_: ^sqlite3_vtab_cursor
	, idxNum: i32
	, idxStr: cstring
	, argc: i32
	, argv: ^^sqlite3_value) -> i32,

	xNext: proc "c" (^sqlite3_vtab_cursor) -> i32,
	xEof:  proc "c" (^sqlite3_vtab_cursor) -> i32,

	xColumn: proc "c" (^sqlite3_vtab_cursor
	, ^sqlite3_context
	, i32) -> i32,

	xRowid: proc "c" (_: ^sqlite3_vtab_cursor
	, pRowid: ^sqlite3_int64) -> i32,

	xUpdate: proc "c" (^sqlite3_vtab
	, i32
	, ^^sqlite3_value
	, ^sqlite3_int64) -> i32,
	...
	xFindFunction: proc "c" (pVtab: ^sqlite3_vtab
	, nArg: i32
	, zName: cstring
	, pxFunc: ^proc "c" (^sqlite3_context
	, i32
	, ^^sqlite3_value)
	, ppArg: ^rawptr) -> i32,

	xRename: proc "c" (pVtab: ^sqlite3_vtab
	, zNew: cstring) -> i32,

	/* The methods above are in version 1 of the sqlite_module object. Those
	** below are for version 2 and greater. */
	xSavepoint: proc "c" (pVTab: ^sqlite3_vtab
	, _: i32) -> i32,

	xRelease: proc "c" (pVTab: ^sqlite3_vtab
	, _: i32) -> i32,

	xRollbackTo: proc "c" (pVTab: ^sqlite3_vtab
	, _: i32) -> i32,
	...
	** Those below are for version 4 and greater. */
	xIntegrity: proc "c" (pVTab: ^sqlite3_vtab
	, zSchema: cstring
	, zTabName: cstring
	, mFlags: i32
	, pzErr: ^cstring) -> i32,
...
foreign lib {
	...
	*/
	sqlite3_create_module :: proc(db: ^sqlite3             /* SQLite connection to register module with */
	, zName: cstring       /* Name of the module */
	, p: ^sqlite3_module /* Methods for the module */
	, pClientData: rawptr        /* Client data for xCreate/xConnect */) -> i32 ---
}

	sqlite3_create_module_v2 :: proc(db: ^sqlite3             /* SQLite connection to register module with */
	, zName: cstring       /* Name of the module */
	, p: ^sqlite3_module /* Methods for the module */
	, pClientData: rawptr       /* Client data for xCreate/xConnect */
	, xDestroy: proc "c" (rawptr /* Module destructor function */) /* Module destructor function */) -> i32 ---
}
	...
	*/
	sqlite3_drop_modules :: proc(db: ^sqlite3        /* Remove modules from this connection */
	, azKeep: ^cstring /* Except, do not remove the ones named here */) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_declare_vtab :: proc(_: ^sqlite3
	, zSQL: cstring) -> i32 ---
}
	...
	** by a [virtual table].
	*/
	sqlite3_overload_function :: proc(_: ^sqlite3
	, zFuncName: cstring
	, nArg: i32) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_blob_open :: proc(_: ^sqlite3
	, zDb: cstring
	, zTable: cstring
	, zColumn: cstring
	, iRow: sqlite3_int64
	, flags: i32
	, ppBlob: ^^sqlite3_blob) -> i32 ---
}
	...
	*/
	sqlite3_blob_reopen :: proc(^sqlite3_blob
	, sqlite3_int64) -> i32 ---
}
	...
	*/
	sqlite3_blob_read :: proc(_: ^sqlite3_blob
	, Z: rawptr
	, N: i32
	, iOffset: i32) -> i32 ---
}
	...
	*/
	sqlite3_blob_write :: proc(_: ^sqlite3_blob
	, z: rawptr
	, n: i32
	, iOffset: i32) -> i32 ---
}
	...
	*/
	...
	sqlite3_vfs_register :: proc(_: ^sqlite3_vfs
	, makeDflt: i32) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_file_control :: proc(_: ^sqlite3
	, zDbName: cstring
	, op: i32
	, _: rawptr) -> i32 ---
}
...
foreign lib {
	...
	*/
	...
	sqlite3_keyword_name :: proc(i32
	, ^cstring
	, ^i32) -> i32 ---
}

	sqlite3_keyword_check :: proc(cstring
	, i32) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_str_appendf :: proc(_: ^sqlite3_str
	, zFormat: cstring, #c_vararg _: ..any) ---
}

	sqlite3_str_vappendf :: proc(_: ^sqlite3_str
	, zFormat: cstring
	, _: c.va_list) ---
}

	sqlite3_str_append :: proc(_: ^sqlite3_str
	, zIn: cstring
	, N: i32) ---
}

	sqlite3_str_appendall :: proc(_: ^sqlite3_str
	, zIn: cstring) ---
}

	sqlite3_str_appendchar :: proc(_: ^sqlite3_str
	, N: i32
	, C: i8) ---
}
	...
	*/
	sqlite3_status :: proc(op: i32
	, pCurrent: ^i32
	, pHighwater: ^i32
	, resetFlag: i32) -> i32 ---
}

	sqlite3_status64 :: proc(op: i32
...
foreign lib {
	...
	*/
	sqlite3_db_status :: proc(_: ^sqlite3
	, op: i32
	, pCur: ^i32
	, pHiwtr: ^i32
	, resetFlg: i32) -> i32 ---
	...
	sqlite3_db_status64 :: proc(^sqlite3
	, i32
	, ^sqlite3_int64
	, ^sqlite3_int64
	, i32) -> i32 ---
...
foreign lib {
	...
	*/
	sqlite3_stmt_status :: proc(_: ^sqlite3_stmt
	, op: i32
	, resetFlg: i32) -> i32 ---
}
...
sqlite3_pcache_methods2 :: struct {
	...
	xCreate: proc "c" (szPage: i32
	, szExtra: i32
	, bPurgeable: i32) -> ^sqlite3_pcache,

	xCachesize: proc "c" (_: ^sqlite3_pcache
	, nCachesize: i32),

	xPagecount: proc "c" (^sqlite3_pcache) -> i32,

	xFetch: proc "c" (_: ^sqlite3_pcache
	, key: u32
	, createFlag: i32) -> ^sqlite3_pcache_page,

	xUnpin: proc "c" (_: ^sqlite3_pcache
	, _: ^sqlite3_pcache_page
	, discard: i32),

	xRekey: proc "c" (_: ^sqlite3_pcache
	, _: ^sqlite3_pcache_page
	, oldKey: u32
	, newKey: u32),

	xTruncate: proc "c" (_: ^sqlite3_pcache
	, iLimit: u32),
...
foreign lib {
	...
	** </ul>
	*/
	sqlite3_backup_init :: proc(pDest: ^sqlite3         /* Destination database handle */
	, zDestName: cstring  /* Destination database name */
	, pSource: ^sqlite3       /* Source database handle */
	, zSourceName: cstring /* Source database name */) -> ^sqlite3_backup ---
}

	sqlite3_backup_step :: proc(p: ^sqlite3_backup
	, nPage: i32) -> i32 ---
}
	...
	** SQLITE_LOCKED.)^
	*/
	sqlite3_unlock_notify :: proc(pBlocked: ^sqlite3                       /* Waiting connection */
	, xNotify: proc "c" (apArg: ^rawptr /* Callback function to invoke */
	, nArg: i32 /* Callback function to invoke */) /* Callback function to invoke */
	, pNotifyArg: rawptr                         /* Argument to pass to xNotify */) -> i32 ---
}
	...
	*/
	sqlite3_stricmp :: proc(cstring
	, cstring) -> i32 ---
}

	sqlite3_strnicmp :: proc(cstring
	, cstring
	, i32) -> i32 ---
}
	...
	*/
	sqlite3_strglob :: proc(zGlob: cstring
	, zStr: cstring) -> i32 ---
}
	...
	*/
	sqlite3_strlike :: proc(zGlob: cstring
	, zStr: cstring
	, cEsc: u32) -> i32 ---
}
	...
	*/
	sqlite3_wal_autocheckpoint :: proc(db: ^sqlite3
	, N: i32) -> i32 ---
}
	...
	*/
	sqlite3_wal_checkpoint :: proc(db: ^sqlite3
	, zDb: cstring) -> i32 ---
}
	...
	** from SQL.
	*/
	sqlite3_wal_checkpoint_v2 :: proc(db: ^sqlite3     /* Database handle */
	, zDb: cstring /* Name of attached database (or NULL) */
	, eMode: i32       /* SQLITE_CHECKPOINT_* value */
	, pnLog: ^i32      /* OUT: Size of WAL log in frames */
	, pnCkpt: ^i32      /* OUT: Total number of frames checkpointed */) -> i32 ---
}
...
foreign lib {
	...
	** is used.
	*/
	sqlite3_vtab_config :: proc(_: ^sqlite3
	, op: i32, #c_vararg _: ..any) -> i32 ---
}
...
foreign lib {
	...
	** </ol>
	*/
	sqlite3_vtab_collation :: proc(^sqlite3_index_info
	, i32) -> cstring ---
}
	...
	*/
	sqlite3_vtab_in :: proc(_: ^sqlite3_index_info
	, iCons: i32
	, bHandle: i32) -> i32 ---
}
	...
	*/
	sqlite3_vtab_in_first :: proc(pVal: ^sqlite3_value
	, ppOut: ^^sqlite3_value) -> i32 ---
}

	sqlite3_vtab_in_next :: proc(pVal: ^sqlite3_value
	, ppOut: ^^sqlite3_value) -> i32 ---
}
	...
	** "Right-Hand Side".
	*/
	sqlite3_vtab_rhs_value :: proc(_: ^sqlite3_index_info
	, _: i32
	, ppVal: ^^sqlite3_value) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_stmt_scanstatus :: proc(pStmt: ^sqlite3_stmt /* Prepared statement for which info desired */
	, idx: i32             /* Index of loop to report on */
	, iScanStatusOp: i32   /* Information desired.  SQLITE_SCANSTAT_* */
	, pOut: rawptr           /* Result written here */) -> i32 ---
}

	sqlite3_stmt_scanstatus_v2 :: proc(pStmt: ^sqlite3_stmt /* Prepared statement for which info desired */
	, idx: i32             /* Index of loop to report on */
	, iScanStatusOp: i32   /* Information desired.  SQLITE_SCANSTAT_* */
	, flags: i32           /* Mask of flags defined below */
	, pOut: rawptr           /* Result written here */) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_snapshot_get :: proc(db: ^sqlite3
	, zSchema: cstring
	, ppSnapshot: ^^sqlite3_snapshot) -> i32 ---
}
	...
	** [SQLITE_ENABLE_SNAPSHOT] compile-time option is used.
	*/
	sqlite3_snapshot_open :: proc(db: ^sqlite3
	, zSchema: cstring
	, pSnapshot: ^sqlite3_snapshot) -> i32 ---
}
	...
	*/
	sqlite3_snapshot_cmp :: proc(p1: ^sqlite3_snapshot
	, p2: ^sqlite3_snapshot) -> i32 ---
}
	...
	** [SQLITE_ENABLE_SNAPSHOT] option.
	*/
	sqlite3_snapshot_recover :: proc(db: ^sqlite3
	, zDb: cstring) -> i32 ---
}
	...
	*/
	sqlite3_serialize :: proc(db: ^sqlite3           /* The database connection */
	, zSchema: cstring   /* Which DB to serialize. ex: "main", "temp", ... */
	, piSize: ^sqlite3_int64 /* Write size of the DB here, if not NULL */
	, mFlags: u32    /* Zero or more SQLITE_SERIALIZE_* flags */) -> ^u8 ---
}
...
foreign lib {
	...
	** [SQLITE_OMIT_DESERIALIZE] option.
	*/
	sqlite3_deserialize :: proc(db: ^sqlite3          /* The database connection */
	, zSchema: cstring  /* Which DB to reopen with the deserialization */
	, pData: ^u8 /* The serialized database content */
	, szDb: sqlite3_int64   /* Number of bytes in the deserialization */
	, szBuf: sqlite3_int64  /* Total size of buffer pData[] */
	, mFlags: u32       /* Zero or more SQLITE_DESERIALIZE_* flags */) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_carray_bind :: proc(pStmt: ^sqlite3_stmt /* Statement to be bound */
	, i: i32               /* Parameter index */
	, aData: rawptr         /* Pointer to array data */
	, nData: i32           /* Number of data elements */
	, mFlags: i32          /* CARRAY flags */
	, xDel: proc "c" (rawptr /* Destructor for aData */) /* Destructor for aData */) -> i32 ---
}
...
foreign lib {
	...
	*/
	sqlite3_rtree_geometry_callback :: proc(db: ^sqlite3
	, zGeom: cstring
	, xGeom: proc "c" (^sqlite3_rtree_geometry
	, i32
	, ^sqlite3_rtree_dbl
	, ^i32) -> i32
	, pContext: rawptr) -> i32 ---
...
sqlite3_rtree_geometry :: struct {
	...
	xDelUser: proc "c" (rawptr  /* Called by SQLite to clean up pUser */), /* Called by SQLite to clean up pUser */
}
...
foreign lib {
	...
	*/
	sqlite3_rtree_query_callback :: proc(db: ^sqlite3
	, zQueryFunc: cstring
	, xQueryFunc: proc "c" (^sqlite3_rtree_query_info) -> i32
	, pContext: rawptr
	, xDestructor: proc "c" (rawptr)) -> i32 ---
}
...
sqlite3_rtree_query_info :: struct {
	...
	xDelUser:      proc "c" (rawptr       /* function to free pUser */), /* function to free pUser */
...
fts5_extension_function :: proc "c" (pApi: ^Fts5ExtensionApi /* API offered by current FTS version */
	, pFts: ^Fts5Context            /* First arg to pass to pApi functions */
	, pCtx: ^sqlite3_context        /* Context for returning result/error */
	, nVal: i32                     /* Number of values in apVal[] array */
	, apVal: ^^sqlite3_value         /* Array of trailing arguments */)
...
Fts5ExtensionApi :: struct {
	...
	xRowCount: proc "c" (_: ^Fts5Context
	, pnRow: ^sqlite3_int64) -> i32,

	xColumnTotalSize: proc "c" (_: ^Fts5Context
	, iCol: i32
	, pnToken: ^sqlite3_int64) -> i32,

	xTokenize: proc "c" (_: ^Fts5Context
	, pText: cstring
	, nText: i32  /* Text to tokenize */
	, pCtx: rawptr /* Context passed to xToken() */
	, xToken: proc "c" (rawptr
	, i32
	, cstring
	, i32
	, i32
	...
	xPhraseSize: proc "c" (_: ^Fts5Context
	, iPhrase: i32) -> i32,

	xInstCount: proc "c" (_: ^Fts5Context
	, pnInst: ^i32) -> i32,

	xInst: proc "c" (_: ^Fts5Context
	, iIdx: i32
	, piPhrase: ^i32
	, piCol: ^i32
	, piOff: ^i32) -> i32,
	...
	xColumnText: proc "c" (_: ^Fts5Context
	, iCol: i32
	, pz: ^cstring
	, pn: ^i32) -> i32,

	xColumnSize: proc "c" (_: ^Fts5Context
	, iCol: i32
	, pnToken: ^i32) -> i32,

	xQueryPhrase: proc "c" (_: ^Fts5Context
	, iPhrase: i32
	, pUserData: rawptr
	, _: proc "c" (^Fts5ExtensionApi
	, ^Fts5Context
	, rawptr) -> i32) -> i32,

	xSetAuxdata: proc "c" (_: ^Fts5Context
	, pAux: rawptr
	, xDelete: proc "c" (rawptr)) -> i32,

	xGetAuxdata: proc "c" (_: ^Fts5Context
	, bClear: i32) -> rawptr,

	xPhraseFirst: proc "c" (_: ^Fts5Context
	, iPhrase: i32
	, _: ^Fts5PhraseIter
	, _: ^i32
	, _: ^i32) -> i32,

	xPhraseNext: proc "c" (_: ^Fts5Context
	, _: ^Fts5PhraseIter
	, piCol: ^i32
	, piOff: ^i32),

	xPhraseFirstColumn: proc "c" (_: ^Fts5Context
	, iPhrase: i32
	, _: ^Fts5PhraseIter
	, _: ^i32) -> i32,

	xPhraseNextColumn: proc "c" (_: ^Fts5Context
	, _: ^Fts5PhraseIter
	, piCol: ^i32),

	/* Below this point are iVersion>=3 only */
	xQueryToken: proc "c" (_: ^Fts5Context
	, iPhrase: i32
	, iToken: i32
	, ppToken: ^cstring
	, pnToken: ^i32) -> i32,

	xInstToken: proc "c" (_: ^Fts5Context
	, iIdx: i32
	, iToken: i32
	, _: ^cstring
	, _: ^i32) -> i32,
	...
	xColumnLocale: proc "c" (_: ^Fts5Context
	, iCol: i32
	, pz: ^cstring
	, pn: ^i32) -> i32,

	xTokenize_v2: proc "c" (_: ^Fts5Context /* Text to tokenize */
	, pText: cstring /* Text to tokenize */
	, nText: i32 /* Text to tokenize */
	, pLocale: cstring /* Locale to pass to tokenizer */
	, nLocale: i32 /* Locale to pass to tokenizer */
	, pCtx: rawptr                       /* Context passed to xToken() */
	, xToken: proc "c" (rawptr /* Callback */
	, i32 /* Callback */
	, cstring /* Callback */
	, i32 /* Callback */
	, i32 /* Callback */
	, i32 /* Callback */) -> i32 /* Callback */) -> i32,
}
...
fts5_tokenizer_v2 :: struct {
	...
	xCreate: proc "c" (_: rawptr
	, azArg: ^cstring
	, nArg: i32
	, ppOut: ^^Fts5Tokenizer) -> i32,

	xDelete: proc "c" (^Fts5Tokenizer),

	xTokenize: proc "c" (_: ^Fts5Tokenizer
	, pCtx: rawptr
	, flags: i32 /* Mask of FTS5_TOKENIZE_* flags */
	, pText: cstring
	, nText: i32
	, pLocale: cstring
	, nLocale: i32
	, xToken: proc "c" (pCtx: rawptr /* Copy of 2nd argument to xTokenize() */
	, tflags: i32 /* Mask of FTS5_TOKEN_* flags */
	, pToken: cstring /* Pointer to buffer containing token */
	, nToken: i32         /* Size of token in bytes */
	, iStart: i32 /* Byte offset of token within input text */
	, iEnd: i32 /* Byte offset of end of token within input text */) -> i32 /* Copy of 2nd argument to xTokenize() */) -> i32,
}
...
fts5_api :: struct {
	...
	xCreateTokenizer: proc "c" (pApi: ^fts5_api
	, zName: cstring
	, pUserData: rawptr
	...
	xFindTokenizer: proc "c" (pApi: ^fts5_api
	, zName: cstring
	, ppUserData: ^rawptr
	, pTokenizer: ^fts5_tokenizer) -> i32,

	/* Create a new auxiliary function */
	xCreateFunction: proc "c" (pApi: ^fts5_api
	, zName: cstring
	, pUserData: rawptr
	...
	/* Create a new tokenizer */
	xCreateTokenizer_v2: proc "c" (pApi: ^fts5_api
	, zName: cstring
	, pUserData: rawptr
	...
	/* Find an existing tokenizer */
	xFindTokenizer_v2: proc "c" (pApi: ^fts5_api
	, zName: cstring
	, ppUserData: ^rawptr
	, ppTokenizer: ^^fts5_tokenizer_v2) -> i32,
}
